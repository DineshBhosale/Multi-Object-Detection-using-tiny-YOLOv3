# -*- coding: utf-8 -*-
"""
Created on Sun Mar 29 14:53:22 2020
...
#load json file
with open('D:/NCSU/ECE 542 - Neural Networks/Final Project/Labels/json/bdd100k_labels_images_train.json') as json_file:
	json_data = json.load(json_file)
#declare file/folder names and paths
working_dir='Labels_xml'
fixed_path = 'D:/NCSU/ECE 542 - Neural Networks/Final Project/Images/train/'
...
for data_index in range(num_of_data):
    ...
    print(file_name)
    output_xml_filename = file_name + '.xml' # output xml file name is {i}.xml ; the image will be renamed in the later part of the code
    file_path = fixed_path + file_name #full path of the image
    renamed_image_path = fixed_path + file_name + '.jpg'
    #XML file structure
